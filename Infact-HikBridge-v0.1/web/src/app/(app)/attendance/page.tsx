  ...
  return (
    <>
      ...
      <div className="filter-bar">
        ...
        <div className="filter-field"><label htmlFor="attendance-status">Status</label><select id="attendance-status" value={status} onChange={(event) => setStatus(event.target.value)}><option value="">All statuses</option><option value="checked_in">Checked in</option><option value="present">Present</option><option value="absent">Absent</option><option value="leave">On leave</option><option value="missing_punch">Missing punch</option><option value="unscheduled_punch">Unscheduled punch</option><option value="holiday">Holiday</option></select></div>
